...
From [WikiStat \| ClickHouse Docs](https://clickhouse.com/docs/getting-started/example-datasets/wikistat):

The dataset contains 0.5 trillion records.

- See the video from FOSDEM 2023: [https://www.youtube.com/watch?v=JlcI2Vfz_uk](https://www.youtube.com/watch?v=JlcI2Vfz_uk)
- And the presentation: [https://presentations.clickhouse.com/fosdem2023/](https://presentations.clickhouse.com/fosdem2023/)
- Data source: [https://dumps.wikimedia.org/other/pageviews/](https://dumps.wikimedia.org/other/pageviews/)
